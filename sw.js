...
const PRECACHE_LIST = [
  ...
  "./js/jquery.min.js",
  "./js/bootstrap.min.js",
  "./js/fengh-blog.min.js",
  "./js/snackbar.js",
  "./img/icon_wechat.png",
  "./img/avatar-fengh.jpg",
  "./img/home-bg.jpg",
  "./img/404-bg.jpg",
  "./css/fengh-blog.min.css",
...
// Tracking https://twitter.com/shushengritian/status/798816417097224193
...
function sendMessageToClientsAsync(msg) {
  ...
  // https://twitter.com/shushengritian/status/799265578443751424
